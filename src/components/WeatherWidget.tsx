...
const SceneClear = ({ transparentBg = false }: { transparentBg?: boolean }) => (
  <svg viewBox="0 0 400 200" preserveAspectRatio="none" style={{ width: "100%", height: "100%", display: "block" }}>
    ...
    <g className="bird" stroke={transparentBg ? "#ffffff" : "#0284c7"} strokeWidth={transparentBg ? 2 : 1.5} fill="none" opacity={transparentBg ? 0.8 : 0.3} style={transparentBg ? { filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.8))" } : undefined}>
...
const SceneCloudy = ({ transparentBg = false }: { transparentBg?: boolean }) => (
  <svg viewBox="0 0 400 200" preserveAspectRatio="none" style={{ width: "100%", height: "100%", display: "block" }}>
    ...
    <g className="cloud-dr" fill="#ffffff" opacity={transparentBg ? 0.5 : 0.1} style={{ animationDelay: "-10s", animationDuration: "35s", ...(transparentBg ? { filter: "drop-shadow(0px 2px 4px rgba(0,0,0,0.4))" } : {}) }}>
      <ellipse cx="300" cy="60" rx="50" ry="18" />
      <ellipse cx="270" cy="55" rx="35" ry="15" />
    </g>

    <g className="bird" stroke={transparentBg ? "#ffffff" : "#0284c7"} strokeWidth={transparentBg ? 2 : 1.5} fill="none" opacity={transparentBg ? 0.8 : 0.25} style={transparentBg ? { filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.8))" } : undefined}>
      <path d="M 50 40 Q 55 35 60 40 Q 65 35 70 40" />
    </g>
  </svg>
);
...
const SceneRain = ({ transparentBg = false }: { transparentBg?: boolean }) => (
  <svg viewBox="0 0 400 200" preserveAspectRatio="none" style={{ width: "100%", height: "100%", display: "block" }}>
    ...
    <g className="bird-fast" stroke={transparentBg ? "#ffffff" : "#475569"} strokeWidth={transparentBg ? 2 : 1.5} fill="none" opacity={transparentBg ? 0.8 : 0.4} style={transparentBg ? { filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.8))" } : undefined}>
...
const SceneStorm = ({ transparentBg = false }: { transparentBg?: boolean }) => (
  <svg viewBox="0 0 400 200" preserveAspectRatio="none" style={{ width: "100%", height: "100%", display: "block" }}>
    ...
    <g className="bird-super-fast" stroke={transparentBg ? "#ffffff" : "#334155"} strokeWidth={transparentBg ? 2.5 : 2} fill="none" opacity={transparentBg ? 0.9 : 0.5} style={transparentBg ? { filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.8))" } : undefined}>
